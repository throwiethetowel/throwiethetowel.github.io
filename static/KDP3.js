...
function getASINs() {
  $('#obr_books option').each(function(index) {
	...
	$('#reportInfoArea').append("<div><h1 id="$<span id='dollas'></span> USD"><span class="slabtext">For one night only</span> <span class="slabtext">Jackie Mittoo</span> <span class="slabtext">with special Studio One guests</span> <span class="slabtext">Dillinger <span class="amp">&amp;</span> Lone Ranger</span></h1>Today: $<span id='dollas'></span> USD - <span id='totalSales'></span> Sales - <span id='totalBorrows'></span> Borrows</h1></div>")
